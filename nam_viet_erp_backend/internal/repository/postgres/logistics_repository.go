...
type LogisticsRepository interface {
	GetOrderForShipping(ctx context.Context, tx *gorm.DB, orderID int64) (*domain.Order, error)
	UpdateOrderShippingStatus(ctx context.Context, tx *gorm.DB, orderID int64, trackingCode string, status string) error
...
func (r *logisticsRepository) GetOrderForShipping(ctx context.Context, tx *gorm.DB, orderID int64) (*domain.Order, error) {
...
func (r *logisticsRepository) UpdateOrderShippingStatus(ctx context.Context, tx *gorm.DB, orderID int64, trackingCode string, status string) error {
