  ...
  public: {
    Tables: {
      ...
      finance_invoice_items: {
        Row: {
          ...
          total_amount_pre_vat: number | null
          updated_at: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "finance_invoice_items_product_unit_id_fkey"
            columns: ["product_unit_id"]
            isOneToOne: false
            referencedRelation: "product_units"
            referencedColumns: ["id"]
      ...
      finance_invoices: {
        Row: {
          ...
          total_price_excludes_vat: number | null
          total_trade_discount: number | null
          updated_at: string | null
        }
        Insert: {
          buyer_tax_code?: string | null
      ...
      suppliers: {
        ...
        Relationships: [
          {
            foreignKeyName: "suppliers_shipping_partner_id_fkey"
            columns: ["shipping_partner_id"]
            isOneToOne: false
            referencedRelation: "shipping_partners"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      create_customer_b2b:
        ...
        | {
            Args: { p_contacts_json?: Json; p_customer_json: Json }
            Returns: number
          }
      create_customer_b2c: {
      ...
      get_mapped_product: {
        ...
        Returns: {
          conversion_rate: number
          internal_product_id: number
          internal_product_unit_id: number
      ...
      search_products_for_quick_barcode_page: {
      ...
      update_customer_b2b:
        | {
            Args: {
              p_contacts_json?: Json
              p_customer_id: number
              p_customer_json: Json
            }
            Returns: undefined
          }
        | {
      ...
      upsert_finance_invoice: {
        Args: { p_invoice_data: Json; p_items_data: Json }
        Returns: number
      }
      ...
      upsert_vendor_product_mapping: {
        Args: {
          p_internal_product_id: number
          p_internal_product_unit_id?: number
          p_internal_unit: string
          p_pre_vat_price?: number
          p_supplier_sku?: string
          p_vat_of_supplier?: number
          p_vendor_product_name: string
          p_vendor_tax_code: string
          p_vendor_unit: string
        }
        Returns: undefined
      }
