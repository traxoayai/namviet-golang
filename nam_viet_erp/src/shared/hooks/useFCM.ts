      ...
      try {
        ...
        if (permission === "granted") {
          const vapidKey =
            ...
            "BDeOprBzYOuFmLH-1Hh1yk3HJrb66K8yaxUi5sgye132FliqJzFLGPv-Np6Nwbjnzxsk08bXmooQXUeT7Jly-xk";
          ...
          message.warning(
            "Vui lòng bấm vào ổ khóa trên thanh địa chỉ để mở quyền Thông báo để nhận được cập nhật theo thời gian thực!"
          );
        }
      } catch (error) {
    ...
    const unsubscribe = onMessage(messaging, (payload) => {
      ...
      notification.info({
        ...
        onClick: () => {
          ...
          const targetUrl =
            anyPayload.data?.click_action ||
            anyPayload.fcmOptions?.link ||
            anyPayload.notification?.click_action ||
            "/";
