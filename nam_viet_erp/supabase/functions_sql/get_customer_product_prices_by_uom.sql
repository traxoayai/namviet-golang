CREATE OR REPLACE FUNCTION public.get_customer_product_prices_by_uom(p_customer_b2b_id bigint, p_items jsonb)
 RETURNS TABLE(product_id bigint, uom text, customer_price numeric, list_price numeric)
 LANGUAGE plpgsql
 SECURITY DEFINER
