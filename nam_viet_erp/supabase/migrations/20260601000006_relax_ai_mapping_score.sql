-- Migration: relax_ai_mapping_score
-- Description: Update map_scanned_invoice_products to lower the fuzzy matching threshold from 0.3 to 0.05 to ensure top match is returned.
...
BEGIN
    ...
    LOOP
        ...
        IF v_internal_id IS NULL AND v_name IS NOT NULL AND v_name != '' THEN
            ...
            -- Lower threshold to 0.05 so it always returns the best guess if there's any matching word
