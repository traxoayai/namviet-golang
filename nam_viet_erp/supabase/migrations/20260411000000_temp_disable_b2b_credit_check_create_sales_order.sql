-- TEMPORARY: Bỏ chặn hạn mức công nợ khi tạo đơn B2B (create_sales_order).
-- Lý do: số liệu nợ trên hệ thống hiện chưa khớp thực tế.
-- Khi dữ liệu ổn định, khôi phục khối E từ migration 20260408170000_fix_default_payment_method.sql
-- hoặc xóa migration này và deploy lại định nghĩa đầy đủ.
-- 2026-04-09
...
BEGIN
  ...
  -- E. CREDIT EXPOSURE CHECK (B2B) — disabled: see migration header
