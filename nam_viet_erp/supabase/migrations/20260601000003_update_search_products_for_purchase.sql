-- Migration: update_search_products_for_purchase
-- Description: Adds formatted_monthly_sales_qty to search_products_for_purchase RPC
...
CREATE OR REPLACE FUNCTION public.search_products_for_purchase(
  ...
  formatted_monthly_sales_qty text,
