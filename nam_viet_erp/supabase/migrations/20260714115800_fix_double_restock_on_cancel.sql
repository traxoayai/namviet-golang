...
BEGIN
    ...
    LOOP
        ...
        -- 2. ĐÃ XÓA: Không tự động cộng vào product_inventory nữa vì trigger trg_sync_product_inventory trên inventory_batches sẽ tự động TÍNH TỔNG và cập nhật kho tổng. (Tránh lỗi cộng đúp 2 lần).
