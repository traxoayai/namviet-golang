-- Migration: Ép kho B2B khi order_type='B2B' trong create_sales_order
-- Mục đích: Fix bug đơn B2B bị gán sai warehouse_id (profile nhân viên / client truyền)
-- Strategy: CREATE OR REPLACE, copy body từ 20260416100000_fix_b2b_order_flow.sql
--           Chỉ thêm override warehouse cho B2B, giữ toàn bộ logic khác
-- An toàn: POS/CLINICAL/non-B2B giữ nguyên hoàn toàn
...
BEGIN
  ...
  -- B. B2B WAREHOUSE OVERRIDE
  -- Nghiệp vụ: đơn B2B luôn xuất từ kho B2B tổng, ignore giá trị client truyền.
  -- Ngăn bug gán nhầm kho retail từ profile nhân viên.
