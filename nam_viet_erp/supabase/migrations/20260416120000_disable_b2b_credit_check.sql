-- =============================================================================
-- TEMP: Disable B2B credit check in create_sales_order()
-- Date: 2026-04-16
-- Reason: Data hạn mức công nợ chưa chính xác, tạm bypass để không block tạo đơn.
-- Revert: Tạo migration mới uncomment Block E khi data đã chuẩn.
-- =============================================================================
...
BEGIN
  ...
  -- E. CREDIT EXPOSURE CHECK (B2B) — DISABLED 2026-04-16: data hạn mức chưa chính xác
  -- Khi cần bật lại: tạo migration mới uncomment block này
