-- 1. Thêm Idempotent Guard vào handle_order_cancellation và hợp nhất logic chuẩn
...
-- 2. Trỏ hàm _cancel_restock cũ sang hàm chuẩn handle_order_cancellation
...
-- 3. Drop trigger cũ bị dư thừa (tránh gọi 2 lần logic Hủy)
DROP TRIGGER IF EXISTS "on_order_cancel" ON "public"."orders";
